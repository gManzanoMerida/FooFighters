 ...
 * @author GMM 
 * 
 * In the previous chapter we learnt how to check emails. Now let us
 *         see how to fetch each email and read its content. Let us write a Java
 *         class FetchingEmail which will read following types of emails:
 * 
 *         Simple email
 * 
...
public class FetchingEmail {
	...
	public static void fetch(String pop3Host, String storeType, String user, String password) {
		try {
			...
			properties.put("mail.store.protocol", Constantes.POP3);
			properties.put(Constantes.MAIL_POP3_HOST, pop3Host);
			properties.put(Constantes.MAIL_POP3_PORT, "995");
			properties.put(Constantes.MAIL_SMTP_STARTTLS_ENABLE, Constantes.TRUE);
	...
	public static void main(String[] args) {
		...
		String username = "g.manzano.merida@gmail.com";// change accordingly
		String password = "Turrican__2018";// change accordingly
